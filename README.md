...
- **Funcionários**: controle semanal da comissão (taxa de serviço de 10%):
  - **Cadastro**: agora tem duas partes — **Funcionários** (só o nome) e **Cargos e pesos** (cadastro editável dos cargos e seus pesos, ex: Garçom=1, Copa=0,5, Louça=0,25, Cozinha=0,5 — vêm pré-cadastrados mas podem ser editados ou novos cargos podem ser criados).
  - **Controle semanal**: a semana vai de **terça a domingo** (sem segunda-feira), fechando sempre no domingo escolhido. Terça, quarta, quinta e domingo dividem o valor do dia inteiro; sexta e sábado dividem separadamente por turno (Dia 11h–17h e Noite 17h+). Para cada dia/turno, escolha o cargo de cada funcionário que trabalhou (o peso e o valor aparecem automáticos) — uma tabela mestre no topo mostra o valor de cada funcionário em cada dia da semana e o total.
  - Se a semana cair em dois meses diferentes, o sistema divide automaticamente o valor lançado em Despesas entre os dois meses, de acordo com quantos dias da semana caíram em cada um.
  - Ao clicar em **"Fechar semana e lançar em Despesas"**, o valor entra automaticamente em Despesas → categoria **"Comissão Funcionários"**, como um item com o intervalo da semana (ex: "Semana 21/07 a 26/07"), já marcado como pago no(s) mês(es) correspondente(s).
